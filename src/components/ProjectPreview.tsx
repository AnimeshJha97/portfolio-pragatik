...
const ProjectPreview = ({ images, theme, colors }: ProjectPreviewParams) => {
  ...
  return (
    <div
      className={`relative w-full border-[1px] h-[300px] md:h-[380px] flex items-center justify-center border-white rounded-lg mb-4 pr-3 pl-3 pt-4 pb-1 overflow-hidden z-[1]`}
    >
      <div className="rounded-t-lg h-[280px] md:h-[360px] overflow-x-scroll relative z-[1]">
        <Image
